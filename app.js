...
app.use(cors({ credentials: true, origin: ['https://localhost:8080', 'http://localhost:8080', 'http://api.getmovies.nomoredomains.xyz', 'https://api.getmovies.nomoredomains.xyz'] }));
